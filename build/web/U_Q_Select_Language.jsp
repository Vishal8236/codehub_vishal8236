   ...
   <div class="repofile"> 
      ...
      <%
        ...
        <div class="col-sm-2 lang ">
            <div class="card">  
                <a href="U_Q_Check_File?languageEnter=<%=lang%>"><img class="card-img-top" src="data:image/jpg;base64,${requestScope['imageBt']}"  width="170" height="170" alt=""></a>
                <div class="card-body text-center">
                               <a class="card-link" style="font-size:20px;" href="U_Q_Check_File?languageEnter=<%=lang%>"><%=lang%></a>
                </div>
            </div>
        </div>
