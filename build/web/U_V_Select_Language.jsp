...
<body>
      ...
      <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-xl-6 col-md-6  ">
                 <h1><b>Welcome In CodeHub <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Video Series</b></h1><br><br> 
            </div>
            <div class="col-xl-6 col-md-6">
 ...
 String connectionURL = "jdbc:mysql://localhost:3306/project1";
        ...
        <div class="card w-85" >  
                ...
                <a href="U_V_Show_Video_File.jsp?language=<%=language1%>"><img class="card-img-top" src="data:image/jpg;base64,${requestScope['imageBt']}"  width="170" height="170" alt=""></a>
                     
            <div class="card-body text-center">
                <a class="card-link text-center" href="U_V_Show_Video_File.jsp?language=<%=language1%>"><%=language1%></a>
            </div>
        </div>
        </div>
