                ...
                <div class="col-lg-8 justify-content-end ml-lg-auto d-flex col-12 col-md-12 justify-content-md-center">
                    <div class="top-info-block d-inline-flex">
                        ...
                        <div class="info-block">
                            <h5 class="font-weight-500">+9630278503</h5>
                            <p>Call Free</p>
                        </div>
                    </div>
                    ...
                    <div class="top-info-block d-inline-flex">
                        ...
                        <div class="info-block">
                            <h5 class="font-weight-500">vishal@example.com</h5>
                            <p>Email Us</p>
                        </div>
                    </div>
                    <div class="top-info-block d-inline-flex">
                        <div class="icon-block">
                            <img src="imgaes/address.png" width="40px" height="40px">
                        </div>
                        <div class="info-block">
                            <h5 class="font-weight-500">Mandsour</h5>
                            <p>Address</p>
                        </div>
                    </div>
                </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-primary main-nav navbar-togglable rounded-radius">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav ">
                        ...
                        <li class="nav-item ">
                            <a href="U_T_Select_Language.jsp" class="nav-link js-scroll-trigger">
                                Tutorial
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a href="U_Admin_Code_Select_Language.jsp" class="nav-link js-scroll-trigger">
                                Code
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a href="U_E_Select_Language.jsp" class="nav-link js-scroll-trigger">
                                Ebook
                            </a>
                        </li>

                        <li class="nav-item ">
                            <a href="U_V_Select_Language.jsp" class="nav-link js-scroll-trigger">
                                Video
                            </a>
                        </li>

                        <li class="nav-item ">
                            <a href="U_Q_Select_Language.jsp" class="nav-link">
                                Quiz
                            </a>
                        </li>
                         <li class="nav-item ">
                            <a href="U_View_Profile.jsp" class="nav-link">
                                Profile
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a href="U_C_Select_Language.jsp" class="nav-link">
                                Private Source Code
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul class="ml-lg-auto list-unstyled m-0">
                        <li><a href="UserLogout" class="btn btn-white btn-circled">Logout</a></li>
                    </ul>
                </div> <!-- / .navbar-collapse -->
            </nav>
        </div> <!-- / .container -->
            ...
            <div class="row  align-items-center">
                <div class="col-md-12 col-lg-7 text-center text-lg-left">
                    <div class="main-banner">
                        ...
                        <!-- Subheading -->
                        <p class="lead mb-4">
                           Codehub is set of landing and support pages aimed at helping developer promote new products and business launches.
                        </p>
