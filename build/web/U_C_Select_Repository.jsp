...
<body>
                    ...
                    <div class="navbar-header">
                            ...
                            <ul class="nav navbar-nav link">
                             ...
                             <ul class="nav navbar-nav navbar-right">
                                <li><a class="btn btn-info" href="U_C_Create_New_Repository.jsp">New Repository</a></li> .&nbsp;.&nbsp;.&nbsp;.&nbsp;.&nbsp;
  ...
  <div class="sidenav">
      <div class="container-fulid">
          <div class="row repo">
            <div class="col-5">
                <div class="alert alert-success alert-dismissible fade show warn text-center">
                    ...
                    <ul class="nav nav-pills nav-stacked ">
                       ...
                       <%
                           String user_id = (String) session.getAttribute("user");
                            ...
                            File f = new File("D:\\my project codehub\\abc\\web\\User Code Repository\\"+user_id+"\\"+selectlanguage+" ");
                       ...
                       %> 
                                  ...
                                  <div class="col-6 rtext">
                                      <a href="U_C_Show_Files_Repository.jsp?reponame=<%=pathname%>"><%=pathname%></a>
                                  </div>
                                  <div class="col-3">
                                      <a  href="U_Download_Repository?rname=<%=pathname%>" onclick="deleterepo()"> 
                                        <img title="download repository" src="imgaes/download.png" width="35px" height="35px">
                                     </a> 
                                  </div>
                                  <div class="col-3">
                                     <a  href="U_C_Delete_Repository?repoN=<%=pathname%>" onclick="if (confirm('Are you sure you want to delete?')) form.action='/Config?pg=FIBiller&amp;cmd=delete'; else return false;"> 
