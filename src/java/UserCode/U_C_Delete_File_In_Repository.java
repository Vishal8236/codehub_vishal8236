 ...
 */
public class U_C_Delete_File_In_Repository extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        File f = new File("D:\\my project codehub\\abc\\web\\User Code Repository\\"+user_id+"\\"+language+"\\"+repo+"\\"+fname+"");
        f.delete();
