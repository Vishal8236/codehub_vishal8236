 ...
 */
public class U_Download_Repository extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response)
        ...
        //select repository
        String repo = request.getParameter("rname");
        
        
        String path = "D:\\my project codehub\\abc\\web\\User Code Repository\\"+user_id+"\\"+language+"\\"+repo+"";
