 ...
 */
public class U_Q_Check_File extends HttpServlet {
...
@Override
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        String query1 = "quiztopic"+language;
        String query2 = "quizques"+language;   
        String filen = "U_Q_"+language+".jsp";
        ...
        if(check=="true")
        {
                 ...
                 RequestDispatcher rs = request.getRequestDispatcher("U_Q_"+language+".jsp");
