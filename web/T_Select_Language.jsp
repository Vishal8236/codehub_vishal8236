        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
            <div class="container-fluid "> 
                <div class="navbar-header">
                      ...
                      <h1><b>Welcome In CodeHub Tutorials</b></h1>   
                ...
                <div class=" ">
                    <div class="form-group col-md-10 form-group p_star form">
                        ...
                        <form name="form1" method="post"  id="register-form" enctype="multipart/form-data" class="register-form input">
                            ...
                            <button type="submit" class="btn btn-primary" formaction="storelanguageatuto">Add</button>
                        </form>
                    </div>        
                </div> 
            </div>
   ...
   <div class="repofile"> 
      ...
      <%
        ...
        <div class="card w-85" >  
                ...
                <a href="tutochecktableindatabase?language=<%=language1%>"><img class="card-img-top" src="data:image/jpg;base64,${requestScope['imageBt']}"  width="170" height="170" alt=""></a>
                     
                <div class="card-body">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-8">
                            <a class="card-link text-left" style="font-size:20px;" href="tutochecktableindatabase?language=<%=language1%>"><%=language1%></a>
                        </div>
                        <div class="col-4">
                            <a  href="T_Delete_Language?languageN=<%=language1%>" onclick="if (confirm('Are you sure you want to delete?')) form.action='/Config?pg=FIBiller&amp;cmd=delete'; else return false;"> 
