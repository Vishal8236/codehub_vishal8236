...
<head>
  ...
  <title>Quiz select langugae</title>
                    ...
                    <div class="form-group col-md-10 form-group p_star form">
                        ...
                        <form name="form1" method="post"  id="register-form" enctype="multipart/form-data" class="register-form input">
                            Language name:
                                 ...
                                 <br>
                            Language logo:
                            <input type="file" name="languageLogo" required>
                            <button type="submit" class="btn btn-primary" formaction="storelanguageaquiz">Add</button>
                        </form>
                    </div>        
                </div> 
            </div>
      ...
      <%
              ...
              try{
                    ...
                    con = DriverManager.getConnection(connectionURL, user, pass);
                     ...
                     PreparedStatement ps = con.prepareStatement("select languagename , logo from quizlanguage ");
        ...
        <div class="col-sm-2 lang ">
            <div class="card w-85" >  
                <a href="checktable?languageEnter=<%=lang%>"><img class="card-img-top" src="data:image/jpg;base64,${requestScope['imageBt']}"  width="170" height="170" alt=""></a>
                <div class="card-body">
                        <div class="row align-items-center justify-content-center">
                            <div class="col-8">
                               <a class="card-link text-left" style="font-size:20px;" href="checktable?languageEnter=<%=lang%>"><%=lang%></a>
                            </div>
                            <div class="col-4">
                                <a  href="Q_Delete_Language?languageN=<%=lang%>" onclick="if (confirm('Are you sure you want to delete?')) form.action='/Config?pg=FIBiller&amp;cmd=delete'; else return false;"> 
