        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
            <div class="container-fluid "> 
                <div class="navbar-header">
                      ...
                      <h1><b>Upload New Book Information</b></h1>   

   </div> 
  <div class="headerimg">
      <div class="alert alert-success alert-dismissible fade show warn text-center">
            PDF File name and book name should be same
       </div>
        <form action="storebookdetails" method="POST" enctype="multipart/form-data">
            <div class="col-lg-6 col-md-6 login">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            
                                <div class="col-md-12 form-group p_star"> <br>
                                    <input type="text" class="form-control"  name="langN" value="" required
                                        placeholder="Enter Language name"> <br><br>
                                    <input class="input100 form-control"  type="text"   name="bookN" value="" required
                                           placeholder="Enter Book Name "><br>
                                    <input type="text" placeholder="How many Page in Book" name="pagen"  required
                                           class="input100 form-control">
                                    <br>
                                    Enter Ebook Image:
                                    <input type="file" class="form-control"  name="ebooklogo" value="" required
                                        placeholder=""> <br>
