...
<html>
                        ...
                        <div class="container-fluid "> 
                            ...
                            <ul class="nav navbar-nav link">
                             ...
                             <ul class="nav navbar-nav navbar-right">
                                <li><a class="btn btn-info" href="U_C_Upload_New_File.jsp?repo=<%=rname%>">Upload New File</a></li> .&nbsp;.&nbsp;.&nbsp;.&nbsp;.&nbsp;
 ...
 <%
                          ...
                          File f = new File("D:\\my project codehub\\abc\\web\\User Code Repository\\"+user_id+"\\"+language+"\\"+rname+"");
                       ...
                       <div class="row align-items-center ">
                        <div class="col-1 ">
                            <a href="U_C_Delete_File_In_Repository?fileN=<%=pathname%>" onclick="if (confirm('Are you sure you want to delete?')) form.action='/Config?pg=FIBiller&amp;cmd=delete'; else return false;"> 
                                <img title="delete repository file" src="imgaes/delete.jpg" width="35px" height="35px">
                            </a>
                        </div>
                        <div class="col-6">
                            <a style="font-size:25px;" href="U_C_Show_Repository_File_Content.jsp?selectfname=<%=pathname%>"><%=pathname%></a><br> 
                        </div>    
                    </div>
                       <%
                            }
