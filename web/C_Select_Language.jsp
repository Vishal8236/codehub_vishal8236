              ...
              <div class="col-xl-6 col-md-6  ">
                  <div class=" ">
                      <div class="form-group col-md-10 form-group p_star form">
                          <a class="btn btn-main" href="C_Add_New_Language.jsp">Add New Language</a>
                      </div>        
                  </div> 
              </div>
              <div class="col-xl-6 col-md-6">
     ...
     <div class="repofile"> 
        ...
        <%
          ...
          <div class="card w-85" >  
                  ...
                  <a href="C_Select_Repository.jsp?languageEnter=<%=pathname%>"><img class="card-img-top" src="imgaes\folder.jpg"  width="170" height="170" alt="img"></a>                     
                  <div class="card-body">
                      <div class="row align-items-center justify-content-center">
                          <div class="col-8">
                              <a class="card-link text-left" style="font-size:20px;" href="C_Select_Repository.jsp?languageEnter=<%=pathname%>"><%=pathname%></a>
                          </div>
                          <div class="col-4">
                              <a  href="C_Delete_Language?languageN=<%=pathname%>" onclick="if (confirm('Are you sure you want to delete?')) form.action='/Config?pg=FIBiller&amp;cmd=delete'; else return false;"> 
